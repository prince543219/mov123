...
# Ask Doubt on telegram @Ban6king9
     ...
     #   if not search:
      ...
      #      return
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/+Nle-Iq1EckRhYjRl")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('ʜᴏᴡ ᴛᴏ ᴜsᴇ ᴏᴜʀ ʙᴏᴛ', url="https://t.me/moviiieeeesss/12")
            ]]
        else:
            buttons = [[
                InlineKeyboardButton('⤬ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ⤬', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
        ...
        buttons = [
            [ 
             ...
             InlineKeyboardButton('ᴍᴜsɪᴄ ʙᴏᴛ', url="https://t.me/Yuxmusicbot")
         ], [
             InlineKeyboardButton('ꜱᴛɪᴄᴋᴇʀ-ɪᴅ', callback_data='sticker'),
             InlineKeyboardButton('ᴊ-ꜱᴏɴ', callback_data='json')
         ],[
             InlineKeyboardButton('ʀᴇǫᴜᴇsᴛ', callback_data='requestmov'),
             InlineKeyboardButton('ᴏᴜʀ ʙᴏᴛs', url="https://t.me/moviiieeeesss/54")
         ], [             
        ...
        buttons = [[
            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/UmbrellaUCorp"),
            InlineKeyboardButton('Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ', url="https://t.me/moviiieeeesss")
        ],[
        ...
        btn = [[
            InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
            InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Ban6king9")
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
        ...
        btn = [[
            ...
            InlineKeyboardButton("Contact", url="telegram.me/Ban6king9")
        ]]
        reply_markup = InlineKeyboardMarkup(btn)
        await client.edit_message_media(
            query.message.chat.id,
...
async def auto_filter(client, name, msg, reply_msg, ai_search, spoll=False):
    ...
    if imdb:
        ...
        if not settings["button"]:
            ...
            for file in files:
                if 'file_id' in file and 'file_size' in file and 'file_name' in file:
                    cap += f"<b>📁 <a href='https://telegram.me/{temp.U_NAME}?start=files_{file['file_id']}'>[{get_size(file['file_size'])}] {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@') and not x.startswith('www.'), file['file_name'].split()))}\n\n</a></b>"
                else:
                    logger.warning(f"File metadata is incomplete: {file}")
