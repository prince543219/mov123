...
@Client.on_message(filters.command("shortlink123"))
...
@Client.on_message(filters.command("setshortlinkoff123"))
...
@Client.on_message(filters.command("setshortlinkon123"))
...
@Client.on_message(filters.command("shortlink_info1234"))
...
@Client.on_message(filters.command("set_tutorial123"))
...
@Client.on_message(filters.command("remove_tutorial1234"))
...
@Client.on_message(filters.command("plan420"))
...
@Client.on_message(filters.command("myplan420"))
